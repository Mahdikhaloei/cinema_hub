"""
Base cinemahub_server settings to build other settings files upon.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": env.str("DATABASE_NAME", default="cinemahub_db"),
...
ADMINS = [("""Mahdi Khaloei""", "m.khaloei.py@gmail.com")]
